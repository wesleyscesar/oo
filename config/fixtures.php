...
{
    $stmt = $conn->prepare("INSERT INTO clientes (nome, endereco, cidade, estado, cpf, telefone, email, pessoa, importancia) VALUES (:nome, :endereco, :cidade, :estado, :cpf, :telefone, :email, :pessoa, :importancia);");
    ...
    $stmt->bindParam(":estado", $cliente['estado'], PDO::PARAM_STR);
    $stmt->bindParam(":cpf", $cliente['cpf'], PDO::PARAM_STR);
    $stmt->bindParam(":telefone", $cliente['telefone'], PDO::PARAM_STR);
    $stmt->bindParam(":email", $cliente['email'], PDO::PARAM_STR);
    $stmt->bindParam(":pessoa", $cliente['pessoa'], PDO::PARAM_STR);
    $stmt->bindParam(":importancia", $cliente['importancia'], PDO::PARAM_STR);
    $stmt->execute();
}
